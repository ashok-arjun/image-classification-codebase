...
if __name__ == '__main__':
    train_dataset = Cub2011('/DATA/arjun_ashok/files/lifelong/avalanche-veniat/autogrow/data', train=True, download=True)
    test_dataset = Cub2011('/DATA/arjun_ashok/files/lifelong/avalanche-veniat/autogrow/data', train=False, download=True)